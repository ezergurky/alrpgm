...
CreateServerPoint()
{
	...
	//Server Money
	new strings[1024];
	MoneyPickup = CreateDynamicPickup(1239, 23, 945.0869,-1673.9796,14.0791, -1, -1, -1, 50.0);
	format(strings, sizeof(strings), "[Keuangan Asia Lane]\n"WHITE_E"Keuangan server: "LG_E"%s", FormatMoney(ServerMoney));
	MoneyText = CreateDynamic3DTextLabel(strings, COLOR_LBLUE, 945.0869,-1673.9796,14.0791, 5.0);
	...
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 1344.85, 1572.11, 3010.90, 5.0); // Apotek hospital
...
function LoadServer()
{
	...
	printf("[Server] Loaded Data Server Asia Lane...");
	printf("[Server] Developer By Aufa....");
