...
House_Type(houseid)
{
	...
	{
	    switch(random(3))//1923.2638,-2252.4407,-86.3594,189.8951
		{
			case 0:
			{
				hData[houseid][hIntposX] = 1923.2638;
				hData[houseid][hIntposY] = -2252.4407;
				hData[houseid][hIntposZ] = -86.3594;
				hData[houseid][hIntposA] = 189.8951;
	...
	{
	    switch(random(2))//1371.6757,-747.9259,3003.5000,7.5493
		{
			case 0:
			{
				hData[houseid][hIntposX] = 1371.6757;
				hData[houseid][hIntposY] = -747.9259;
				hData[houseid][hIntposZ] = 3003.5000;
				hData[houseid][hIntposA] = 7.5493;
				hData[houseid][hInt] = 1;
			}
			case 1:
			{
...
CMD:myhouse(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_MY_HOUSES, DIALOG_STYLE_LIST, "Asialane - House", CMDSString, "Pilih", "Batal");
	return 1;
}
