...
{ 
    if(!IsPlayerInAnyVehicle(playerid))
        return SendClientMessage(playerid, -1, "Ошибка: Чтобы использовать команду ты должен быть в транспорте."); 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                case 4: SetDynamicObjectMaterial(para[vid],2,10412,"hotel1", "carpet_red_256",0x00FFFFFF);
            } 
