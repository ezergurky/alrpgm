...
stock Inventory_Show(playerid)
{
	...
	SelectTextDraw(playerid, COLOR_LRED);
	for(new a = 0; a < 6; a++)
	{
...
function OnPlayerGiveInvItem(playerid, otherid, itemid, name[], value)
{
	...
	{
		if(pData[playerid][pMoney] < value)
		...
		ShowItemBox(otherid, "Uang", str, 1212, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
	...
	{
		if(pData[playerid][pKanabis] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Kanabis", str, 800, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pKanabis] -= value;
		pData[otherid][pKanabis] += value;
	}
	else if(!strcmp(name, "Botol", true))
	{
		if(pData[playerid][pBotol] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Botol", str, 1486, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pBotol] -= value;
		pData[otherid][pBotol] += value;
	}
	else if(!strcmp(name, "Marijuana", true))
	{
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Marijuana", str, 1578, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pMarijuana] -= value;
		pData[otherid][pMarijuana] += value;
	}
	else if(!strcmp(name, "Sampah", true))
	{
		if(pData[playerid][sampahsaya] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Sampah", str, 1265, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][sampahsaya] -= value;
		pData[otherid][sampahsaya] += value;
	}
	else if(!strcmp(name, "Jerigen", true))
	{
		if(pData[playerid][pGas] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Jerigen", str, 1650, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pGas] -= value;
		pData[otherid][pGas] += value;
	}
	else if(!strcmp(name, "Paket_Ayam", true))
	{
		if(pData[playerid][AyamFillet] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Paket_Ayam", str, 19566, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][AyamFillet] -= value;
		pData[otherid][AyamFillet] += value;
	}
	else if(!strcmp(name, "Susu", true))
	{
		if(pData[playerid][pSusu] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Susu", str, 19570, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSusu] -= value;
		pData[otherid][pSusu] += value;
	}
	else if(!strcmp(name, "Ayam", true))
	{
		if(pData[playerid][AyamHidup] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Ayam", str, 16776, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][AyamHidup] -= value;
		pData[otherid][AyamHidup] += value;
	}
	else if(!strcmp(name, "Ayam_Potong", true))
	{
		if(pData[playerid][AyamPotong] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Ayam_Potong", str, 2806, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][AyamPotong] -= value;
		pData[otherid][AyamPotong] += value;
	}
	else if(!strcmp(name, "Susu_Olahan", true))
	{
		if(pData[playerid][pSusuOlahan] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Susu_Olahan", str, 19569, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSusuOlahan] -= value;
		pData[otherid][pSusuOlahan] += value;
	}
	else if(!strcmp(name, "Pakaian", true))
	{
		if(pData[playerid][pPakaian] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Pakaian", str, 11741, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pPakaian] -= value;
		pData[otherid][pPakaian] += value;
	}
	else if(!strcmp(name, "Water", true))
	{
		if(pData[playerid][pSprunk] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Water", str, 2958, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSprunk] -= value;
		pData[otherid][pSprunk] += value;
	}
	else if(!strcmp(name, "Starling", true))
	{
		if(pData[playerid][pStarling] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Starling", str, 1455, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pStarling] -= value;
		pData[otherid][pStarling] += value;
	}
	else if(!strcmp(name, "Steak", true))
	{
		if(pData[playerid][pSteak] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Steak", str, 19811, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSteak] -= value;
		pData[otherid][pSteak] += value;
	}
	else if(!strcmp(name, "Vest", true))
	{
		if(pData[playerid][pVest] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Vest", str, 1242, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pVest] -= value;
		pData[otherid][pVest] += value;
	}
	else if(!strcmp(name, "Batu", true))
	{
		if(pData[playerid][pBatu] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Batu", str, 905, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pBatu] -= value;
		pData[otherid][pBatu] += value;
	}
	else if(!strcmp(name, "Milx_Max", true))
	{
		if(pData[playerid][pMilxMax] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Milx_Max", str, 19570, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pMilxMax] -= value;
		pData[otherid][pMilxMax] += value;
	}
	else if(!strcmp(name, "Snack", true))
	{
		if(pData[playerid][pSnack] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Snack", str, 2821, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSnack] -= value;
		pData[otherid][pSnack] += value;
	}
	else if(!strcmp(name, "Roti", true))
	{
		if(pData[playerid][pRoti] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Roti", str, 19883, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pRoti] -= value;
		pData[otherid][pRoti] += value;
	}
	else if(!strcmp(name, "Kebab", true))
	{
		if(pData[playerid][pKebab] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Kebab", str, 2769, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pKebab] -= value;
		pData[otherid][pKebab] += value;
	}
	else if(!strcmp(name, "Cappucino", true))
	{
		if(pData[playerid][pCappucino] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Cappucino", str, 19835, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pCappucino] -= value;
		pData[otherid][pCappucino] += value;
	}
	else if(!strcmp(name, "Emas", true))
	{
		if(pData[playerid][pEmas] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Emas", str, 19941, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pEmas] -= value;
		pData[otherid][pEmas] += value;
	}
	else if(!strcmp(name, "Aluminium", true))
	{
		if(pData[playerid][pAluminium] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Aluminium", str, 19809, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pAluminium] -= value;
		pData[otherid][pAluminium] += value;
	}
	else if(!strcmp(name, "Perban", true))
	{
		if(pData[playerid][pPerban] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Perban", str, 11736, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pPerban] -= value;
		pData[otherid][pPerban] += value;
	}
	else if(!strcmp(name, "Obat_Stress", true))
	{
		if(pData[playerid][pObatStress] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Obat_Stress", str, 1241, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pObatStress] -= value;
		pData[otherid][pObatStress] += value;
	}
	else if(!strcmp(name, "Besi", true))
	{
		if(pData[playerid][pBesi] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Besi", str, 1510, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pBesi] -= value;
		pData[otherid][pBesi] += value;
	}
	else if(!strcmp(name, "Minyak", true))
	{
		if(pData[playerid][pMinyak] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Minyak", str, 2969, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pMinyak] -= value;
		pData[otherid][pMinyak] += value;
	}
	//hasil tani
	else if(!strcmp(name, "bijikopi", true))
	{
		if(pData[playerid][pBijikopi] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "bijikopi", str, 2880, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pBijikopi] -= value;
		pData[otherid][pBijikopi] += value;
	}

	else if(!strcmp(name, "sariteh", true))
	{
		if(pData[playerid][pSariteh] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "sariteh", str, 2353, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSariteh] -= value;
		pData[otherid][pSariteh] += value;
	}
	else if(!strcmp(name, "sarijeruk", true))
	{
		if(pData[playerid][pSarijeruk] < value)
				return Error(playerid, "Item anda tidak cukup.");

		format(str, sizeof(str), "Removed_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(playerid, "sarijeruk", str, 19574, 2);

		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "sarijeruk", str, 19574, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSarijeruk] -= value;
		pData[otherid][pSarijeruk] += value;
	}
	else if(!strcmp(name, "Beras", true))
	{
		if(pData[playerid][pBeras] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Beras", str, 19638, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pBeras] -= value;
		pData[otherid][pBeras] += value;
	}
	else if(!strcmp(name, "Sambal", true))
	{
		if(pData[playerid][pSambal] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Sambal", str, 19636, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pSambal] -= value;
		pData[otherid][pSambal] += value;
	}
	else if(!strcmp(name, "Tepung", true))
	{
		if(pData[playerid][pTepung] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Tepung", str, 19570, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pTepung] -= value;
		pData[otherid][pTepung] += value;
	}
	else if(!strcmp(name, "Gula", true))
	{
		if(pData[playerid][pGula] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Gula", str, 19824, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pGula] -= value;
		pData[otherid][pGula] += value;
	}
	...
	{
		if(pData[playerid][pKopiruq] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "kopiruq", str, 19835, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pKopiruq] -= value;
		pData[otherid][pKopiruq] += value;
	}
	else if(!strcmp(name, "esteh", true))
	{
		if(pData[playerid][pEsteh] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "esteh", str, 2647, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pEsteh] -= value;
		pData[otherid][pEsteh] += value;
	}
	else if(!strcmp(name, "esjeruk", true))
	{
		if(pData[playerid][pEsjeruk] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "esjeruk", str, 19563, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pEsjeruk] -= value;
		pData[otherid][pEsjeruk] += value;
	}
	else if(!strcmp(name, "Nasikucing", true))
	{
		if(pData[playerid][pNasikucing] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Nasikucing", str, 2465, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pNasikucing] -= value;
		pData[otherid][pNasikucing] += value;
	}
	else if(!strcmp(name, "Ayamgeprek", true))
	{
		if(pData[playerid][pAyamgeprek] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Ayamgeprek", str, 2768, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pAyamgeprek] -= value;
		pData[otherid][pAyamgeprek] += value;
	}
	else if(!strcmp(name, "kue", true))
	{
		if(pData[playerid][pKueaufa] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "kue", str, 19525, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pKueaufa] -= value;
		pData[otherid][pKueaufa] += value;
	}
	//kunci lokcpick
	else if(!strcmp(name, "Kunci", true))
	{
		if(pData[playerid][pLockPick] < value)
				return Error(playerid, "Item anda tidak cukup.");
		...
		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Kunci", str, 2237, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pLockPick] -= value;
		pData[otherid][pLockPick] += value;
	}
	else if(!strcmp(name, "Uang merah", true))
	{
		if(pData[playerid][pRedMoney] < value)
				return Error(playerid, "Item anda tidak cukup.");

		format(str, sizeof(str), "Removed_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(playerid, "Uang merah", str, 1550, 2);

		format(str, sizeof(str), "Received_%dx", pData[playerid][pGiveAmount]);
		ShowItemBox(otherid, "Uang merah", str, 1550, 2);

		ApplyAnimation(playerid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);
		ApplyAnimation(otherid, "DEALER", "shop_pay", 4.1, 0, 1, 1, 0, 0, 1);

		pData[playerid][pRedMoney] -= value;
		pData[otherid][pRedMoney] += value;
	}
...
public OnPlayerUseItem(playerid, itemid, name[])
{
	...
	//makan hasil menu makan pedagang
	else if(!strcmp(name, "Nasikucing"))
	{
	    callcmd::mamnasikucing(playerid, "");
	}
	else if(!strcmp(name, "Ayamgeprek"))
	{
	    callcmd::mamayamgeprek(playerid, "");
	}
	else if(!strcmp(name, "Kue"))
	{
	    callcmd::mamkue(playerid, "");
	}
	//minum hasil menu minum pedagang
	else if(!strcmp(name, "kopiruq"))
	{
	    callcmd::numkopi(playerid, "");
	}
	else if(!strcmp(name, "esteh"))
	{
	    callcmd::numesteh(playerid, "");
	}
	else if(!strcmp(name, "esjeruk"))
	{
	    callcmd::numesjeruk(playerid, "");
	}
...
stock CreatePlayerInv(playerid)
{
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][0], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][1], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][2], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][3], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][4], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][5], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][6], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][7], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][8], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][9], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][10], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][11], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][12], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][13], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][14], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][15], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][16], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][17], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][18], -12254977);
	...
	PlayerTextDrawColor(playerid, GARISBAWAH[playerid][19], -12254977);
	...
	PlayerTextDrawColor(playerid, INVNAME[playerid][0], 1887473919);
	...
	PlayerTextDrawTextSize(playerid, INVNAME[playerid][1], 165.000, 3.000);
	PlayerTextDrawAlignment(playerid, INVNAME[playerid][1], 1);
	PlayerTextDrawColor(playerid, INVNAME[playerid][1], -12254977);
	...
	INVNAME[playerid][3] = CreatePlayerTextDraw(playerid, 126.000, 105.000, "Aufa Jumantara");
	...
	INVNAME[playerid][5] = CreatePlayerTextDraw(playerid, 295.000, 104.000, "ILRP");
	...
	PlayerTextDrawColor(playerid, INVINFO[playerid][0], 1887473919);
	...
	PlayerTextDrawColor(playerid, INVINFO[playerid][1], -12254977);
	...
	PlayerTextDrawColor(playerid, INVINFO[playerid][2], -12254977);
	...
	PlayerTextDrawColor(playerid, INVINFO[playerid][3], -12254977);
	...
	PlayerTextDrawColor(playerid, INVINFO[playerid][4], -12254977);
	...
	PlayerTextDrawColor(playerid, INVINFO[playerid][5], -12254977);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][0], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][1], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][2], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][3], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][4], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][5], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][6], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][7], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][8], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][9], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][10], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][11], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][12], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][13], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][14], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][15], 0.119, 0.597);
	...
	AMOUNTTD[playerid][19] = CreatePlayerTextDraw(playerid, 166.000, 330.000, "10000x");
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][19], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][17], 0.119, 0.597);
	...
	PlayerTextDrawLetterSize(playerid, AMOUNTTD[playerid][18], 0.119, 0.597);
...
stock BarangMasuk(playerid)
{
		...
		Inventory_Set(playerid, "Nasikucing", 2465, pData[playerid][pNasikucing], pData[playerid][pNasikucing]);
		Inventory_Set(playerid, "Ayamgeprek", 2768, pData[playerid][pAyamgeprek], pData[playerid][pAyamgeprek]);
		Inventory_Set(playerid, "kue", 19525, pData[playerid][pKueaufa], pData[playerid][pKueaufa]);
		...
		Inventory_Set(playerid, "Beras", 19638, pData[playerid][pBeras], pData[playerid][pBeras]);
		...
		// 742 = hasil olahan benih kopi
		// 2247 = hasil olahan benih teh
		// 741 = hasil olahan benih jeruk

		// 2880 = biji kopi
		// 2353 = sari teh
		// 19574 = sari jeruk
		//bibit
		Inventory_Set(playerid, "benihkopi", 756, pData[playerid][pBenihkopi], pData[playerid][pBenihkopi]);
		Inventory_Set(playerid, "benihteh", 677, pData[playerid][pBenihteh], pData[playerid][pBenihteh]);
		Inventory_Set(playerid, "benihjeruk", 859, pData[playerid][pBenihjeruk], pData[playerid][pBenihjeruk]);
		//hasil olah
		Inventory_Set(playerid, "olahkopi", 742, pData[playerid][pOlahkopi], pData[playerid][pOlahkopi]);
		Inventory_Set(playerid, "olahteh", 2247, pData[playerid][pOlahteh], pData[playerid][pOlahteh]);
		Inventory_Set(playerid, "olahjeruk", 741, pData[playerid][pOlahjeruk], pData[playerid][pOlahjeruk]);
		//barnag hasil
		Inventory_Set(playerid, "bijikopi", 2880, pData[playerid][pBijikopi], pData[playerid][pBijikopi]);
		Inventory_Set(playerid, "sariteh", 2353, pData[playerid][pSariteh], pData[playerid][pSariteh]);
		Inventory_Set(playerid, "sarijeruk", 19574, pData[playerid][pSarijeruk], pData[playerid][pSarijeruk]);
		//menu minum pedagang
		Inventory_Set(playerid, "kopiruq", 19835, pData[playerid][pKopiruq], pData[playerid][pKopiruq]);
		Inventory_Set(playerid, "esteh", 2647, pData[playerid][pEsteh], pData[playerid][pEsteh]);
		Inventory_Set(playerid, "esjeruk", 19563, pData[playerid][pEsjeruk], pData[playerid][pEsjeruk]);

		//kunci robbank
		Inventory_Set(playerid, "kunci", 2237, pData[playerid][pLockPick], pData[playerid][pLockPick]);
		Inventory_Set(playerid, "Uang merah", 1550, pData[playerid][pRedMoney], pData[playerid][pRedMoney]);
		...
		Inventory_Set(playerid, "Umpan", 1485, pData[playerid][pUmpanaufa], pData[playerid][pUmpanaufa]);
		Inventory_Set(playerid, "Pancinganaufa", 18632, pData[playerid][pPancinganaufa], pData[playerid][pPancinganaufa]);
