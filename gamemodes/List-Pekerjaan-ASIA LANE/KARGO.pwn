function MuatBarang(playerid)
{
	...
	InfoMsg(playerid, "Bawa muatan kembali ke ~y~Pelabuhan Asialane ~w~ikutilah tanda.");
...
CMD:kargo(playerid, params[])
{
    if(pData[playerid][pJob] == 8)
	{
		...
		ShowPlayerDialog(playerid, DIALOG_KARGO, DIALOG_STYLE_TABLIST_HEADERS, "{BABABA}Asialane - {FFFFFF}Pilih Kargo", "Jenis\nBarang\nPertamina", "Pilih", "Tutup");
	}
	return 1;
}
